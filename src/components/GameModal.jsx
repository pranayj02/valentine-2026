  ...
  return (
    ...
    >
      ...
      <div className="game-legend">
        <span className="legend-ladder">Green = Ladder (climb up — that moment)</span>
        <span className="legend-snake">Red = Snake (slide down — that moment)</span>
      </div>
        ...
        {gameState.showMoment && (
          ...
          >
            <div className={`moment-popup-content ${gameState.showMoment.mood}`}>
              {gameState.showMoment.date && (
                <span className="moment-popup-date">
                  {new Date(gameState.showMoment.date).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}
                </span>
              )}
